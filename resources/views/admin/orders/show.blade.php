                    ...
                    <div class="row ">
                        @if ($order->payment_method == 'manual')
                            <div class="col-lg-6 justify-content-start col-xl-4 col-xl-3 ml-sm-auto pb-4">
                                <h4>Payment Slip :</h4>
                                <br>
                                <img  src="{{ Storage::url($order->payment_slip) }}" width="600" alt="">
                            </div>
                        @endif
                        <div class="col-lg-5 justify-content-end col-xl-4 col-xl-3 ml-sm-auto pb-4">
                            ...
                            @if (!$order->trashed())
                                    @if ($order->isPaid() && $order->isConfirmed() && $order->payment_method != 'cod')
                                    ...
                                    @endif
                                    @if ($order->payment_status == 'waiting' && $order->payment_method == 'manual')
